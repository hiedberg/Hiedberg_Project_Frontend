...
export const detail = [
  'Onboarding is made simple, once you subscribe you will be sent an email with a link to the Client Portal and the steps to begin updating your account. A member of our team will call you within an hour to welcome you and introduce themselves as your dedicated assistant.',
  ...
  'Tasks can be set directly via the “Tasks” section in your client portal. Your task will be reviewed, and an estimated time will be set for how long the task will take to be completed. You will be notified on this both in the email section of the portal and a copy will be sent to your personal email. That way, you are always informed about status of tasks.',
  'Hiedberg’s Client Portal has both email and messenger integrations. This means, you can send an email via the portal or message your assistant directly. Video calls are also integrated in the portal so you can schedule a time for a video call with your assistant.',
  'At Hiedberg, we are focused on hiring the best candidates with university degrees with a minimum of 3 years work experience in similar role. Our team is diverse and highly qualified to ensure your get the best out of our work.',
  ...
  'Our payment processes are made as easy as possible, simply subscribe to our subscription packages online and payment will be process from your card every 30 days. Invoices are automatically produced and accessible from the “Billing” section of the Client Portal.',
  'We have a 30-day notice cancellation period.',
  'You can upgrade or add services via your account. You can find this under the “Subscriptions” section of the Client Portal. You will receive an email upon successful completion of the upgrading process.',
  'Yes, you can purchase top-up hours if you run out of hours before the end of the month. You can only purchase up to 5 hours of top-up within a billing period.',
];
export const question = [
  'What is the on-boarding process?',
  'What do I prepare to ensure productive onboarding process?',
  'How do I set tasks?',
  'What is the best way to communicate with my assistant?',
  'How experienced and qualified are Hiedberg Virtual Assistants?',
