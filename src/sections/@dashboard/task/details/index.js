        ...
        <Grid container>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            <Box sx={{ textAlign: { sm: 'right' } }}>
              ...
              <Typography variant="h6">{taskNumber}</Typography>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            ...
            <Typography variant="body2">{taskFrom.name}</Typography>
            <Typography variant="body2">{taskFrom.address}</Typography>
            <Typography variant="body2">Phone: {taskFrom.phone}</Typography>
          </Grid>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            ...
            <Typography variant="body2">{taskTo.name}</Typography>
            <Typography variant="body2">{taskTo.address}</Typography>
            <Typography variant="body2">Phone: {taskTo.phone}</Typography>
          </Grid>
