...
export default function TaskPDF({ task }) {
  const {
    items,
    taxes,
    status,
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            <Text style={[styles.overline, styles.mb8]}>Task from</Text>
            <Text style={styles.body1}>{taskFrom.name}</Text>
            <Text style={styles.body1}>{taskFrom.address}</Text>
            <Text style={styles.body1}>{taskFrom.phone}</Text>
          </View>

          <View style={styles.col6}>
            <Text style={[styles.overline, styles.mb8]}>Task to</Text>
            <Text style={styles.body1}>{taskTo.name}</Text>
            <Text style={styles.body1}>{taskTo.address}</Text>
            <Text style={styles.body1}>{taskTo.phone}</Text>
          </View>
        </View>
        ...
        <Text style={[styles.overline, styles.mb8]}>Task Details</Text>
