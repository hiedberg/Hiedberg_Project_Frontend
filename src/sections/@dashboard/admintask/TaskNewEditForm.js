...
// ----------------------------------------------------------------------
const DEMO_TASKS = [
  { value: 'research', label: 'Research Article Task' },
  { value: 'health', label: 'Health Consult Task' },
  { value: 'education', label: 'Training Education Task' },
  { value: 'it', label: 'Backnd Development' },
  { value: 'development', label: 'PDF to WORD' },
];
const DEMO_STAFFS = [
  { value: 'high', label: 'John Doe' },
  { value: 'medium', label: 'Hanif' },
  { value: 'low', label: 'Esmat' },
];
// ----------------------------------------------------------------------
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={8}>
          <Card sx={{ p: 3 }}>
            ...
            >
              <RHFTextField name="title" label="Task123232" disabled />
              <RHFSelect name="task" label="Task" placeholder="Country">
                <option value="" />
                {DEMO_TASKS.map((option) => (
                  <option key={option.code} value={option.label}>
                    {option.label}
                  </option>
                ))}
              </RHFSelect>
              <RHFSelect name="staff" label="Staff" placeholder="Country">
                <option value="" />
                {DEMO_STAFFS.map((option) => (
                  <option key={option.code} value={option.label}>
                    {option.label}
                  </option>
                ))}
            ...
            <Stack Stack justifyContent="flex-end" direction="row" spacing={2} sx={{ mt: 3 }}>
              ...
              <LoadingButton type="submit" variant="contained" loading={isSubmitting}>
                {!isEdit ? 'Assign Task' : 'Save Changes'}
              </LoadingButton>
            </Stack>
          </Card>
        </Grid>
